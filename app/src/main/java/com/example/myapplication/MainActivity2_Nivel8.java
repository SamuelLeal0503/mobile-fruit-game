...
public class MainActivity2_Nivel8 extends AppCompatActivity {
    ...
    ImageView ivAuno, ivAdos, ivAtres,iv_vidas;
    EditText et_respuesta;
    MediaPlayer mp, mp_great, mp_bad;
    int score, numAleatorio_uno, numAleatorio_dos, numAleatorio_tres, resultado, vidas = 3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivAtres = findViewById(R.id.imageView_NumeroTres);
    ...
    private void numeroAleatorio() {
        if (score < 80) {
            ...
            Toast.makeText(this, "¡Has completado el juego! ¡Felicidades!", Toast.LENGTH_SHORT).show();
            gameOver();
        }
    }
